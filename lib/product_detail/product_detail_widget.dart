                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 10.0,
                                                                0.0, 0.0),
                                                    child: Text(
                                                      'Rich Punjabi Makhani curry with melt in mouth paneer + Dal Makhani /Chole/ Dilli Rajma',
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                              .bodyMedium
                                                  ...
                                                  ClipRRect(
                                                    borderRadius:
                                                        BorderRadius.circular(
                                                            8.0),
                                                    child: Image.network(
                                                      'https://images.unsplash.com/photo-1504674900247-0877df9cc836?crop=entropy&cs=srgb&fm=jpg&ixid=M3w0NTYyMDF8MHwxfHNlYXJjaHwxfHxmb29kfGVufDB8fHx8MTY5NTM5ODk3Mnww&ixlib=rb-4.0.3&q=85',
                                                      width: 316.0,
                                                      height: 95.0,
                                                      fit: BoxFit.cover,
                                                    ),
